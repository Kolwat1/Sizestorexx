...
$all_history_shop = $thxk->all_history_shop();
?>
<style>
    .modal-content {
...
<div class="container-fluid mt-2 p-0">
    ...
    <div class="container p-4 pt-0 pb-0 m-cent">
        <div class="class-thxk p-3 mt-4 mb-3" data-aos="zoom-in" data-aos="700">
            <center>
                <h4>ประวัติการซื้อแบบสต็อกสินค้า</h4>
                <hr>
            </center>
            <div class="table-responsive">
                <table id="history_buy1" class="table table-striped table-dark text-center" style="width:100%">
                    ...
                    <tbody>
                        <?php foreach ($all_history_shop as $history_product) { ?>
                            <tr>
                                <td><?= $history_product['id'] ?></td>
                                <td><?= $history_product['name'] ?></td>
                                <td><?= $history_product['details'] ?></td>
                                <td><?= $history_product['username'] ?></td>
                                <td><?= $history_product['date'] ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
