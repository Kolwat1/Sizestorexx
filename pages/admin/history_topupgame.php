...
$all_history_topupgame = $thxk->all_history_topupgame();
?>
<style>
    .modal-content {
        ...
        <div class="class-thxk p-3 mt-4 mb-3" data-aos="zoom-in" data-aos="700">
            ...
            <div class="table-responsive">
                <table id="history_buy1" class="table table-striped table-dark text-center" style="width:100%">
                    ...
                    <tbody>
                        <?php foreach ($all_history_topupgame as $history_game) { ?>
                            <tr>
                                <td><?= $history_game['id'] ?></td>
                                <td><?= $history_game['topupby'] ?></td>
                                <td><?= $history_game['price'] ?></td>
                                <td><?= $history_game['list'] ?></td>
                                <td>สำเร็จ <?= $history_game['status'] ?></td>
                                <td><?= $history_game['topuptime'] ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
